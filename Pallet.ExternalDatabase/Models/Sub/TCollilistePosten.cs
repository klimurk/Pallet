...
{
    /// <summary>
    /// Posten der Colliliste
    /// </summary>
    [Table("t_colliliste_posten")]
    [Index("NMainId", "NAuftragId", Name = "IDX_COLLILISTE_AUFTRAG")]
    public partial class TCollilistePosten
    {
        [Key]
        [Column("n_id")]
        ...
        [Column("c_bez_uebersetzung")]
        [StringLength(45)]
        public string CBezUebersetzung { get; set; }
