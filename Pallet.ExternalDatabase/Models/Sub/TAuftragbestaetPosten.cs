...
{
    /// <summary>
    /// Posten zur Auftragsbestätigung
    /// </summary>
    [Table("t_auftragbestaet_posten")]
    [Index("NAuftragId", Name = "IDX_AUFTRAG")]
    public partial class TAuftragbestaetPosten
    {
        [Key]
        [Column("n_id")]
        public int NId { get; set; }
        [Column("n_auftragbestaet_id")]
        public int NAuftragbestaetId { get; set; }
        [Column("n_kunde_id")]
