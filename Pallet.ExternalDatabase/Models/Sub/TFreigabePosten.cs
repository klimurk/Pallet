...
{
    /// <summary>
    /// Posten der Fertigmeldung, welche die finalen Verpckungsdaten beinhaltet
    /// </summary>
    [Table("t_freigabe_posten")]
    [Index("NAuftragId", Name = "IDX_AUFTRAG")]
    [Index("NMainId", "NAuftragId", Name = "IDX_FREIGABE_AUFTRAG")]
    public partial class TFreigabePosten
    {
        [Key]
        [Column("n_id")]
