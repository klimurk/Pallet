        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    A1_CONF = table.Column<string>(type: "char(5)", nullable: true),
                    A2_CONF = table.Column<string>(type: "char(5)", nullable: true),
                    B1_CONF = table.Column<string>(type: "char(5)", nullable: true),
                    B2_CONF = table.Column<string>(type: "char(5)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileProducts", x => new { x.ProductId, x.ProfileId });
                    table.ForeignKey(
