...
namespace Pallet.Database.Migrations
{
    ...
    [Migration("20220526123553_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Products.ElementPosition", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Products.Nail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Products.Product", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Profiles.Profile", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Profiles.ProfileProducts", b =>
                {
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Profiles.ProfileTools", b =>
                {
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Tables.Table", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("PlaceA1Cofiguration")
                    ...
                    b.Property<string>("PlaceA2Cofiguration")
                        .HasColumnType("char(5)")
                    ...
                    b.Property<int>("PlaceASizeX")
                        .HasColumnType("int")
                        .HasColumnName("A_SIZE_X");

                    b.Property<int>("PlaceASizeY")
                        .HasColumnType("int")
                        .HasColumnName("A_SIZE_Y");

                    b.Property<string>("PlaceB1Cofiguration")
                        .HasColumnType("char(5)")
                    ...
                    b.Property<string>("PlaceB2Cofiguration")
                        .HasColumnType("char(5)")
                    ...
                    b.Property<int>("PlaceBSizeX")
                        .HasColumnType("int")
                        .HasColumnName("B_SIZE_X");

                    b.Property<int>("PlaceBSizeY")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Tools.Tool", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Types.Element", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Types.Nailer", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pallet.Database.Entities.OPC.Alarm", b =>
                {
                    ...
                    b.Property<string>("Alarmtext1")
                        .HasColumnType("nvarchar(200)")
                        .HasColumnName("TEXT1");

                    b.Property<string>("Alarmtext2")
                        .HasColumnType("nvarchar(200)")
                        .HasColumnName("TEXT2");

                    b.Property<string>("Alarmtext3")
                        .HasColumnType("nvarchar(200)")
                        .HasColumnName("TEXT3");
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Products.ElementPosition", b =>
                {
                    b.HasOne("Pallet.Database.Entities.Change.Types.Element", "Element")
                        .WithMany("Positions")
                        .HasForeignKey("ELE_ID");

                    b.HasOne("Pallet.Database.Entities.Change.Products.Product", "Product")
                        .WithMany("Elements")
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Products.Nail", b =>
                {
                    b.HasOne("Pallet.Database.Entities.Change.Types.Nailer", "Nailer")
                        .WithMany("Nails")
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Profiles.Profile", b =>
                {
                    b.HasOne("Pallet.Database.Entities.Change.Tables.Table", "Table")
                        .WithMany("Profiles")
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Profiles.ProfileProducts", b =>
                {
                    ...
                    b.HasOne("Pallet.Database.Entities.Change.Profiles.Profile", "Profile")
                        .WithMany("ProfileProducts")
            ...
            modelBuilder.Entity("Pallet.Database.Entities.Change.Profiles.ProfileTools", b =>
                {
                    ...
                    b.HasOne("Pallet.Database.Entities.Change.Tools.Tool", "Tool")
                        .WithMany("ProfileTools")
