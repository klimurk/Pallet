...
using Pallet.InternalDatabase.Entities.OPC.Interfaces;
using System.ComponentModel;
using System.ComponentModel.DataAnnotations.Schema;

namespace Pallet.InternalDatabase.Entities.OPC;

/// <summary>
/// The OPC Alarms logging data.
/// </summary>
[Table("ALARM_LOG")]
public class AlarmLog : NamedEntity, IAlarm, IValueNotified
{
    [Column(Order = 0)]
    ...
    public DateTime? TimestampEnd
    {
        ...
        set
        {
            _TimestampEnd = value;
            Gone = true;
            OnPropertyChanged(new PropertyChangedEventArgs(nameof(TimestampEnd)));
        }
    }
